...
def editaVendSaid():
    ...
    #Menu Principal
    #time.sleep(5)
    #Chama o método insereNumeroVendSaid
    time.sleep(15)
    insereNumeroVendSaid()
    time.sleep(5)
    ...
    #Espera 10 segundos
    time.sleep(10)
    #Clica para editar a Venda Saída depois de fazer o filtro
    ...
    #Aperta TAB  15 vezes para chegar no campo Qtde
    ...
    time.sleep(20)
    #Chama o método concluirVendSaid para concluir a Venda Saída
    concluirVendSaid()
    #Implementado 06/01/2022
    time.sleep(5)
    #Chama o método fechaTela para fechar a tela de Venda Saída
    fechaTela()
    time.sleep(5)
