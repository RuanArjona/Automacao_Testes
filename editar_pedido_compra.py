...
#Método implementado - Fernando 08/12/2021
def editaPedComp():
    ...
    imppedsaida()
    time.sleep(5)
    #Chama o método concluirPedComp para concluir o Pedido Compra
    concluirPedComp()
    #Implementado 06/01/2022
    time.sleep(5)
    #Chama o método fechaTela para fechar a tela de Pedido de Compra
    fechaTela()
    time.sleep(5)
